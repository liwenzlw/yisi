...
public class Configure {
	...
	private static String key = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab";

	// 微信分配的公众号ID（开通公众号之后可以获取到）
	private static String appID = "wxe7d44221d679efaf";

	// 微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private static String mchID = "1283521201@1283521201";
